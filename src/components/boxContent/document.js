            ...
            <div className="textwidget">
                <div className="form-loan loan-page ">
                        ...
                        <div role="form" className="wpcf7" id="wpcf7-f477-o1" lang="en-US" dir="ltr">
                            ...
                            <form action="/en/about-us#wpcf7-f477-o1" method="post" className="wpcf7-form">
                                <h3>{documentTitle}</h3>
                                <p>
                                        ...
                                        <span className="wpcf7-form-control wpcf7-radio">
                                            {
                                                listItemRadio.map(item => (
                                                    <span className="wpcf7-list-item first" key={item.content}>
                                                        <input type="radio" name="giayto-kh" defaultValue={item.content} />
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <span className="wpcf7-form-control-wrap yout-tel">
                                                <input type="tel" name="yout-tel" defaultValue="" size="40" className="wpcf7-form-control wpcf7-text wpcf7-tel wpcf7-validates-as-required wpcf7-validates-as-tel" aria-required="true" aria-invalid="false" 
                                                placeholder={placeHolderInput.phoneNumber} />
                                            </span>
                                        </li>
                                        <li>
                                            <span className="wpcf7-form-control-wrap your-address">
                                                <input type="text" name="your-address" defaultValue="" size="40" className="wpcf7-form-control wpcf7-text wpcf7-validates-as-required" aria-required="true" aria-invalid="false" 
                                        ...
                                        <span className="wpcf7-form-control-wrap your-city">
                                            <select name="your-city" className="wpcf7-form-control wpcf7-select" aria-invalid="false">
                                                {
                                                    listCity.map(city=>(
                                                        <option defaultValue={city.content} key={city.content} >{city.content}</option>
                                                    ))
                                                }
                                            </select>
                                        </span>
                                    ...
                                    <ul>
                                        <li>
                                            <span className="wpcf7-form-control-wrap your-idcard">
                                                <input type="tel" name="your-idcard" defaultValue="" size="40" className="wpcf7-form-control wpcf7-text wpcf7-tel wpcf7-validates-as-tel" aria-invalid="false" 
                                                    placeholder={placeHolderInput.idCard} />
                                            </span>
                                        </li>
                                        <li>
                                            <span className="wpcf7-form-control-wrap your-moneyloan">
                                                <input type="text" name="your-moneyloan" defaultValue="" size="40" className="wpcf7-form-control wpcf7-text" aria-invalid="false" 
                                                    placeholder={placeHolderInput.loan} />
                                            </span>
                                        </li>
                                        <li>
                                            <span className="wpcf7-form-control-wrap your-salary">
                                                <input type="text" name="your-salary" defaultValue="" size="40" className="wpcf7-form-control wpcf7-text" aria-invalid="false" 
                                                    placeholder={placeHolderInput.monthly} />
                                            </span>
                                        </li>
                                        <li> 
                                            <span className="wpcf7-form-control-wrap email-your-mail">
                                                <input type="email" name="email-your-mail" defaultValue="" size="40" className="wpcf7-form-control wpcf7-text wpcf7-email wpcf7-validates-as-email" aria-invalid="false" 
                                                    placeholder={placeHolderInput.email} />
                                            </span>
                                        </li>
                                    </ul>
                                </div>
                                <p style={{ textAlign : 'center'}}><input type="submit" defaultValue="Loan Now" className="wpcf7-form-control wpcf7-submit" /></p>
